<nav>
    <ul>
        ...
        <li><a href="group_journeys.php">Journeys</a>
            <ul>
        ...
        <li><a href="group_journeys.php">Groups</a>
            <ul>
                ...
                <li><a href="forms/Group_Registration_Form.pdf" download>Group Registration Form</a></li>
            </ul>
        </li>
        <li><a href="TC_journeys.php">Travel Club</a>
            <ul>
                ...
                <li><a href="forms/Individual_Registration_Form.pdf" download>Member Registration Form</a></li>
            </ul>
        </li>
        <li><a href="manage_vehicles.php">Vehicles</a>
            <ul>
                <li><a href="manage_vehicles.php">Manage Vehicles</a></li>
                <li><a href="add_vehicle.php">Add vehicle</a></li>
            </ul>
        </li>
        <li><a href="manage_drivers.php">Drivers</a>
            <ul>
